...
pub const PERF_COUNT_SW_MAX: perf_sw_ids = 10;
...
pub const PERF_SAMPLE_BRANCH_MAX_SHIFT: perf_branch_sample_type_shift = 12;
...
pub const PERF_SAMPLE_BRANCH_MAX: perf_branch_sample_type = 4096;
...
const _: () = {
    ...
    ["Offset of field: perf_event_attr::__reserved_2"]
        [::std::mem::offset_of!(perf_event_attr, __reserved_2) - 108usize];
};
...
impl perf_event_attr {
    ...
    pub fn __reserved_1(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(26usize, 38u8) as u64) }
    }
    #[inline]
    pub fn set___reserved_1(&mut self, val: __u64) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set(26usize, 38u8, val as u64)
        }
    }
    #[inline]
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(26usize, 38u8, {
...
pub const PERF_RECORD_MAX: perf_event_type = 13;
