...
pub const PERF_SAMPLE_BRANCH_MAX: perf_branch_sample_type = 2048;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of perf_event_attr"][::std::mem::size_of::<perf_event_attr>() - 104usize];
    ...
    ["Offset of field: perf_event_attr::__reserved_2"]
        [::std::mem::offset_of!(perf_event_attr, __reserved_2) - 92usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of perf_event_mmap_page"][::std::mem::size_of::<perf_event_mmap_page>() - 1040usize];
...
pub const PERF_RECORD_MAX: perf_event_type = 11;
