...
pub const PERF_SAMPLE_BRANCH_MAX_SHIFT: perf_branch_sample_type_shift = 13;
...
pub const PERF_SAMPLE_BRANCH_MAX: perf_branch_sample_type = 8192;
...
pub const PERF_RECORD_MAX: perf_event_type = 14;
