...
/// Copy-on-write chunk.
///
/// This type holds a reference to the underlying ring buffer data, so it is
/// necessary to drop this type as early as possible to avoid the ring buffer
/// being stuck due to insufficient space.
